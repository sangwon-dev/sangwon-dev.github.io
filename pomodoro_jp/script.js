...
function startTimer() {
  ...
  timer = setInterval(() => {
    ...
    if (seconds < 0) {
      ...
      if (minutes < 0) {
        ...
        setTimeout(() => {
          ...
          document.title = '集中力向上のための時間管理 - POMODORO';
    ...
    document.title = `${minutesDisplay.textContent}:${secondsDisplay.textContent} - POMODORO (集中力向上のための時間管理)`;
  }, 1000);
}
